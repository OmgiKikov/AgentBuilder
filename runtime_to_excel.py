...
# Чтение JSON файла
fila_name = "run_time_result_qwen_qwen-2.5-72b-instruct"
with open(f'benchmark/run_time/{fila_name}.json', 'r', encoding='utf-8') as file:
    data = json.load(file)
