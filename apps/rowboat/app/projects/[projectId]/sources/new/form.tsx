                ...
                <div className="max-w-[768px] mx-auto flex flex-col gap-4">
                    ...
                    >
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                name="description"
                                placeholder="Пример: Справка из нашей документации"
                                rows={2}
                                className="rounded-lg p-3 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-750 focus:shadow-inner focus:ring-2 focus:ring-indigo-500/20 dark:focus:ring-indigo-400/20 placeholder:text-gray-400 dark:placeholder:text-gray-500"
                            />
                        </div>
                        <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                            ...
                            <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400 ml-7">
                                <li className="flex items-start">
                                    ...
                                    <span>Ожидайте около 5-10 минут для сканирования 100 страниц</span>
                                </li>
                                <li className="flex items-start">
                                    <span className="mr-2">•</span>
                                    <span>Будут сканироваться только первые 100 (действительных) URL</span>
                                </li>
                            </ul>
                        </div>
                        <FormStatusButton
                    ...
                    >
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                required
                                name="name"
                                placeholder="Пример: Документация"
                                rows={1}
                                className="rounded-lg p-3 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-750 focus:shadow-inner focus:ring-2 focus:ring-indigo-500/20 dark:focus:ring-indigo-400/20 placeholder:text-gray-400 dark:placeholder:text-gray-500"
                            />
                        </div>
                        <div className="space-y-2">
                            ...
                            <Textarea
                                name="description"
                                placeholder="Пример: Коллекция документов"
                                rows={2}
                                className="rounded-lg p-3 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-750 focus:shadow-inner focus:ring-2 focus:ring-indigo-500/20 dark:focus:ring-indigo-400/20 placeholder:text-gray-400 dark:placeholder:text-gray-500"
                            />
                        </div>
                    ...
                    >
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                required
                                name="name"
                                placeholder="Пример: Документация продукта"
                                rows={1}
                                className="rounded-lg p-3 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-750 focus:shadow-inner focus:ring-2 focus:ring-indigo-500/20 dark:focus:ring-indigo-400/20 placeholder:text-gray-400 dark:placeholder:text-gray-500"
                            />
                        </div>
                        <div className="space-y-2">
                            ...
                            <Textarea
                                name="description"
                                placeholder="Пример: Коллекция документации для нашего продукта"
                                rows={2}
                                className="rounded-lg p-3 border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-750 focus:shadow-inner focus:ring-2 focus:ring-indigo-500/20 dark:focus:ring-indigo-400/20 placeholder:text-gray-400 dark:placeholder:text-gray-500"
                            />
                        </div>
